...
\lstset{
        language=Java,
        keywords={function, method, type, constant, assert, assume,
          debug, for, while, switch, is, if, case, return, export, native,
          else, process, define, as, throw, requires, ensures, where, no, new,
          all, some, bool, int, byte, char, string, void, real, in, any,
...
%        frameround=tttt,
	...
	tab=\rightarrowfill,
        ...
        literate={tau}{{$\tau$}}1 {tau'}{{$\tau\prime$}}1 {(|}{{$\lpbar$}}1 
