...
\begin{tabular}{l@{\hspace*{-0.9cm}}r}
...
\token{\lstinline+|ls|+} \token{\lstinline+ls[0]+} \token{\lstinline|xs++ys|} \token{\lstinline|xs++[1]|} \token{\lstinline|xs[0..2]|}& {\em Lists}\\
...
\lstinputlisting{../examples/remove.whiley}
