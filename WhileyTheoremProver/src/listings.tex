...
\newcommand{\clstinline}[1]{\tcbox[tcbox raise
  base,colback=gray,colframe=darkgray,nobeforeafter,boxrule=0.5pt,left=0mm,right=0mm,top=0mm,bottom=0mm]{\lstinline|#1|}}
...
{
  morekeywords={
    assert,define,exists,forall,if,then,is,type
  },
  sensitive=false,
  morecomment=[l]{//},
  morecomment=[s]{/*}{*/}
