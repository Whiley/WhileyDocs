...
In this case, we have two alternate (and completely equivalent) definitions for a natural number (we can see that \lstinlinec{bnat} is equivalent to \lstinlinec{anat} by subtracting \lstinlinec{x} from both sides). 
