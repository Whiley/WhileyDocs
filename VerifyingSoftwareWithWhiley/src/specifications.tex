...
In this chapter, we explore what it means to provide specifications for programs written in the Whiley Programming Language.  At this early stage, we are only concerned with getting the specification right, and not with determining whether our program actually meets its specification.
...
\section{Overview of Specifications}
