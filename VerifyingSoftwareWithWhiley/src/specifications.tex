...
In this chapter, we explore what it means to provide specifications for programs written in the Whiley Programming Language.  At this early stage, we are more concerned with how write specifications than with determining whether our programs meet their specifications.
