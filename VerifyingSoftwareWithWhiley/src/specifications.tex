...
\subsection{Meeting the Specification}
...
\subsection{Meeting the Specification (Client Side)}
...
\subsection{Basics}
\begin{itemize}
\item Logic connectives: implication, and, or, etc.
\item Invariants can only use pure functions
\end{itemize}
