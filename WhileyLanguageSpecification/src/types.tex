...
{\tt v} & ::= & {\tt null} && \textrm{(null value)}\\
    ...
    & | & {\tt i\ /\ n} & {\tt \textrm{if}\;i\in\mathbb{Z}\;\textrm{and}\;n\in\mathbb{N}\;\textrm{and}\;\textrm{gcd}(i_1,i_2)=1} & \textrm{(rational values)}\\
...
Discuss the implications of these distinct sets of values.
