...
An {\em invalid lval} error occurs when an invalid expression is use on the left-hand side of an assignment.  Only expressions which are also lval's maybe used in such a situation  (see~\S\ref{c_stmts_lval}).
