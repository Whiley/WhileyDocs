...
\newglossaryentry{infeasible_path}{
  ...
  description={A valid path through the control-flow graph of a function or method for which no valid parameter values exist which will let it be executed}
}
