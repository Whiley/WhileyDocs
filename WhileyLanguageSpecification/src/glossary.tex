...
\newglossaryentry{refinable_expression}{ 
  name={refinable expression},
  description={An expression which may be refined by a runtime type
    test.  A refinable expression is either a variable access or a
    field access on a refinable expression} }
