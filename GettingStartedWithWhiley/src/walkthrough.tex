...
\noindent This function iterates over each key$\times$value pair (i.e. \lstinline{k,v}) in a from integers to integer lists (i.e. \lstinline|{int=>[int]}|) using the \lstinline{for} statement.
