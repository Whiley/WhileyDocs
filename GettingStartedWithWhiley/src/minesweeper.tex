...
\lstinputlisting[firstline=49,lastline=61]{../examples/minesweeper.whiley}
...
\lstinputlisting[firstline=64,lastline=67]{../examples/minesweeper.whiley}
...
\lstinputlisting[firstline=70,lastline=74]{../examples/minesweeper.whiley}
...
\lstinputlisting[firstline=81,lastline=91]{../examples/minesweeper.whiley}
...
\lstinputlisting[firstline=98,lastline=107]{../examples/minesweeper.whiley}
...
\lstinputlisting[firstline=110,lastline=123]{../examples/minesweeper.whiley}
...
\lstinputlisting[firstline=125,lastline=131]{../examples/minesweeper.whiley}
...
\lstinputlisting[firstline=139,lastline=153]{../examples/minesweeper.whiley}
